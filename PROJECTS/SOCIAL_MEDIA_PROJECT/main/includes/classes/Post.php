...
class Post
{
    ...
    public function submitPost($body, $user_to, $imageName)
    {
        ...
        if ($check_empty != "") {
            ...
            // insert post
            $query = mysqli_query($this->connection, "INSERT INTO posts (body,added_by,user_to,date_added,user_closed,deleted,likes,image) VALUES('$body','$added_by','$user_to','$date_added','no','no','0','$imageName')");
            ...
            $number_posts = $this->user_object->getNumberPosts();
            $number_posts++;
    ...
    public function loadPostsFriends($data, $limit)
    {
        ...
        if (mysqli_num_rows($data_query) > 0) {
            ...
            while ($row = mysqli_fetch_array($data_query)) {
                ...
                // prepare user_to string it can be included even if not posted to a user
                if ($row['user_to'] == "none") {
                    $user_to = "";
                } else {
                ...
                if ($user_logged_object->isFriend($added_by)) {
                    ...
                    $comments_check_number = mysqli_num_rows($comments_check);
                    // time frame
                    $time = new Time($date_time);
                    $time_message = $time->getTime();
                    ...
                    $str .= "<div class='status_post'               onclick='javascript:toggle$id()'>
                                ...
                                <div class='newsFeedPostOptions'>
                                  Comments($comments_check_number) &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    public function loadProfilePosts($data, $limit)
    {
        ...
        $str = ""; // string to return
        $data_query = mysqli_query($this->connection, "SELECT * FROM posts WHERE deleted='no' AND ((added_by='$profileUsername' AND user_to='none') OR user_to='$profileUsername')  ORDER BY id DESC");
